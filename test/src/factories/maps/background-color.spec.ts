import { backgroundColorMap } from '../../../../src/factories/maps/background-color';

const expectedBackgroundColorMap = {
...
describe('Given a color map', () => {
  test('then the map should be as expected', () => {
    expect(backgroundColorMap).toStrictEqual(expectedBackgroundColorMap);
  });
});

export { expectedBackgroundColorMap };
