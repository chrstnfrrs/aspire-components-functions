...
import { mdBackgroundColorMap } from '../../../../src/factories/maps/md-background-color';

const expectedMdBackgroundColorMap = {
...
describe('Given a material design color map', () => {
  test('then the map should be as expected', () => {
    expect(mdBackgroundColorMap).toStrictEqual(expectedMdBackgroundColorMap);
  });
});

export { expectedMdBackgroundColorMap };
