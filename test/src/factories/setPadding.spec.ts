...
describe('setPadding', () => {
  checkFactory(setPadding, 'setPadding', 'padding', keys);
  checkFactoryArray(setPadding, 'setPadding', 'padding', keys);
  checkFactoryStringList(setPadding, 'setPadding', 'padding', keys);
});
